...
public class FileUploadController {
	...
	public String showUploadForm () {
		return "admin/view_upload_file/fileform";
	}
	
	@RequestMapping(value = { "/fileform_new" }, method = RequestMethod.GET)
	public String showUploadFormNew () {
		return "admin/view_upload_file/fileform_new";
	}
	...
	public String fileupload (@RequestParam("profile") CommonsMultipartFile file, HttpSession s, Model m) {
		...
		return "admin/view_upload_file/filesuccess";
	}
}
