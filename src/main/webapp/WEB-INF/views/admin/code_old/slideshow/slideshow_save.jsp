...
<head>
	<title>Admin - Add Slideshow</title>
</head>
<body>
				...
				<div class="col-md-12">
					<div class="card ">
						<div class="header">
							...
							<div class="col-md-4">
								<a href="<c:url value='/admin/slideshow/list' />" style="float: right;">
						...
						<div class="content">
							<div class="row">
								<div class="col-md-12">
									...
									<c:url value="/admin/saveSlideshow?${_csrf.parameterName}=${_csrf.token}" var="saveSlideshow" />
