...
<head>
<meta charset="UTF-8">
<title>ANSV - Administrator</title>
</head>
<body>
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card ">
						<div class="header">
							<h4 class="title">Global Sales by Top Locations Thành</h4>
										...
										<table class="table">
											<tbody>
												<tr>
													<td>
														<div class="flag">
															<img src="<c:url value='/assets/admin/img/flags/US.png' />" />
														</div>
													</td>
													<td>USA</td>
												...
												<tr>
													<td>
														<div class="flag">
															<img
																src="<c:url value='/assets/admin/img/flags/DE.png' />" />
														</div>
													</td>
													<td>Germany</td>
												...
												<tr>
													<td>
														<div class="flag">
															<img
																src="<c:url value='/assets/admin/img/flags/AU.png' />" />
														</div>
													</td>
													<td>Australia</td>
												...
												<tr>
													<td>
														<div class="flag">
															<img
																src="<c:url value='/assets/admin/img/flags/GB.png' />" />
														</div>
													</td>
												...
												<tr>
													<td>
														<div class="flag">
															<img
																src="<c:url value='/assets/admin/img/flags/RO.png' />" />
														</div>
													</td>
													<td>Romania</td>
												...
												<tr>
													<td>
														<div class="flag">
															<img
																src="<c:url value='/assets/admin/img/flags/BR.png' />" />
														</div>
													</td>
													<td>Brasil</td>
								...
								<table class="table">
									<tbody>
										<tr>
											<td>
												<div class="checkbox">
													<input id="checkbox30" type="checkbox"> <label
														for="checkbox30"></label>
												</div>
											</td>
										...
										<tr>
											<td>
												<div class="checkbox">
													<input id="checkbox32" type="checkbox"> <label
														for="checkbox32"></label>
												</div>
											</td>
										...
										<tr>
											<td>
												<div class="checkbox">
													<input id="checkbox35" type="checkbox" checked> <label
										...
										<tr>
											<td>
												<div class="checkbox">
													<input id="checkbox38" type="checkbox"> <label
														for="checkbox38"></label>
												</div>
											</td>
										...
										<tr>
											<td>
												<div class="checkbox">
													<input id="checkbox40" type="checkbox" checked> <label
														for="checkbox40"></label>
												</div>
											</td>
